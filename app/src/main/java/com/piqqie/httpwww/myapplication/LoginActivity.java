...
public class  LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     * TODO: remove after connecting too a real authentication system.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String loggedIn = settings.getString("piqqie_username", "no");
        //mEmail = "nickmazz@my.yorku.ca";
        ...
        Button forgotPasswordText = (Button) findViewById(R.id.forgot_password);
        forgotPasswordText.setTypeface(myFont);
        //Trying to force the lower case letters for this field
        //forgotPasswordText.setText("Forgot Password?");
        Button loginButton = (Button) findViewById(R.id.log_in_button);
        loginButton.setTypeface(myFont);

        mRegisterButton = (Button) findViewById(R.id.create_an_account);
        // This is how I set the font for create an account button
        mRegisterButton.setTypeface(myFont);
        //Trying to force the lower case letters for this field
        //mRegisterButton.setText("Create An Account");

        // Set up the login form.
        mEmailView = (AutoCompleteTextView) findViewById(R.id.email);
		// This is how I set the font for your email
        mEmailView.setTypeface(myFont);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.password);
		 // This is how I set the font for your password
        mPasswordView.setTypeface(myFont);
		...
		// This is how I set the font for the login button
        mEmailSignInButton.setTypeface(myFont);
        ...
        mRegisterButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                mRegisterButton = (Button) findViewById(R.id.create_an_account);
				// I am not too sure if I need to set the font for this button again here
                Typeface myFont = Typeface.createFromAsset(getAssets(), "Montserrat-Regular.ttf");
                mRegisterButton.setTypeface(myFont);
                //Trying to manually set the button text
                //mRegisterButton.setText("Create An Account");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                editor.commit();
                Intent homePage = new Intent(LoginActivity.this, home_swipe.class);
